 ...
 * ============================================================
 * Puerto verbatim de `frontend/src/utils/precioImpresion.js` (que a su vez
 * está espejado en el backend — ver ese archivo para el porqué de tenerlo
 * duplicado). Aquí solo se MUESTRA el precio antes de enviar; el que vale es
 * el que calcula el backend al crear el pedido.
 *
